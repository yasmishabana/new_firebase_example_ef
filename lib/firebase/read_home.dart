...
import 'package:new_firebase_example_ef/firebase/add.dart';
import 'package:new_firebase_example_ef/firebase/edit_dialog.dart';
import 'package:new_firebase_example_ef/firebase/widgets/text_style.dart';

class FirebaseHomePage extends StatefulWidget {
  const FirebaseHomePage({Key? key}) : super(key: key);

  @override
  State<FirebaseHomePage> createState() => _HomePageState();
}

class _HomePageState extends State<FirebaseHomePage> {
    ...
    return StreamBuilder<QuerySnapshot>(
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          if (snapshot.hasError) {
            ...
            log('Something Wrong in HomePage');
          }
